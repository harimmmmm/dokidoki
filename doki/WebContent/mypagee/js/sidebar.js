document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentUrl.includes('home')) {
        ...
        document.getElementById('past-link').style.boxShadow = '4px 0 0 0 #486988 inset';
    } else if (currentUrl.includes('canceled')) {
        document.getElementById('canceled-link').style.boxShadow = '4px 0 0 0 #486988 inset';
    } else if (currentUrl.includes('interest')) {
        document.getElementById('interest-link').style.boxShadow = '4px 0 0 0 #486988 inset';
    } else if (currentUrl.includes('inquiries')) {
        document.getElementById('inquiries-link').style.boxShadow = '4px 0 0 0 #486988 inset';
    }
});
